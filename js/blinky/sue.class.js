...
function Franky(x, z, width, height, depth) {
...
Franky.prototype.setInternal = function(x, y, z) {
	this.internalX = x;
	this.internalY = y;
	this.internalZ = z;
}
...
Franky.prototype.getMesh = function() {
	return this.mesh;
}

// Called by game loop on keyboard input.
Franky.prototype.setDirection = function(direction) {
	this.interrupt = false;
...
Franky.prototype.tweener = function(clear) {
...
// zero.
Franky.prototype.interruptTweener = function() {
	if (this.tween > 0) {
		this.tween -= this.tweenSpeed;
		return this.tween;
	} else {
...
Franky.prototype.validMove = function(direction) {
	switch (direction) {
		case 1:
...
Franky.prototype.smoothMove = function() {
	var newPosition;
...
Franky.prototype.ghostAI = function() {
	var valid = true;
	var movement = [];
...
if(valid) {
	 ...
	 franky.beDumb(movement)
	// this.direction = franky.seek(movement, this.positionX, this.positionY);
	// //console.log(this.direction);
...
Franky.prototype.beDumb = function(movement) {
...
Franky.prototype.seek = function(movement, x, y) {
...
// Update
Franky.prototype.update = function() {
	// this.smoothMove();
	...
	if (this.time <= 0) { 
		...
		switch(this.direction){
			case 1:
				...
				frankyCapsule.rotation.z -= (8 * Math.PI/180);
				break;
			case 4:
				this.positionY = this.positionY - 1;
				//franky.setDirection("z-");
...
// Stat
Franky.prototype.stat = function() {
